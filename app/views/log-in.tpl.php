<div class="flex justify-center items-center">
    <section class="w-9/12 flex flex-col items-center rounded p-14 relative sm:w-max">
        ...
        <form action="" method="post" class="flex flex-col w-full mt-10 sm:w-max">
            ...
            <input type="text" name="firstname" id="" class="mt-2.5 mb-5 h-14 rounded border-primary border-2 p-2 sm:w-80">
            <label for="lastname">Nom</label>
            <input type="text" name="lastname" id="" class="mt-2.5 mb-5 h-14 rounded border-primary border-2 p-2 sm:w-80">
