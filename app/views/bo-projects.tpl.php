  ...
  <div class="sm:flex sm:gap-5 sm:flex-wrap">
    <div class="bg-white rounded border-t-2 border-primary my-5 p-5 sm:w-80">
      ...
      <div class="flex justify-start gap-2">
        <img src="/assets/images/icons/react_mono.png" alt="" class="w-5" />
        <img src="/assets/images/icons/javascript_mono.svg" alt="" class="w-5" />
        <img src="/assets/images/icons/docker_mono.svg" alt="" class="w-5" />
      </div>
      <p class="my-2">
