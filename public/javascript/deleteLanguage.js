const deleteLanguage = {
    init: function () {
        ...
        btnDeleteLanguage.addEventListener("click", () => deleteLanguage.handlerDeleteLanguage(labelId))
    },

    handlerDeleteLanguage: async function (labelId) {
        console.log("delete language", labelId)

        const response = await fetch(`http://localhost:8000/bo-delete--technos/${labelId}`, {
            method: "DELETE",
            headers: {
